...
def _pressure_row(
    ...
    row = {
        ...
        "value_per_work_event_mean_delta": _metric_mean_delta(
            high_pressure_rows,
            normal_rows,
            "value_per_work_event_total",
        ),
...
def _pressure_delta_field(observable_prefix: str) -> str:
    delta_fields = {
        ...
        "value_per_work_event": "value_per_work_event_mean_delta",
...
def _pressure_delta_lines(row: dict[str, Any]) -> list[str]:
    return [
        ...
        f"- {row['policy']} value per work event mean pressure delta: "
        f"{row['value_per_work_event_mean_delta']}",
...
def _pressure_curve_lines(row: dict[str, Any]) -> list[str]:
    return [
        ...
        f"- {row['policy']} value per work event pressure curve: "
        f"normal_to_medium_slope={row['value_per_work_event_normal_to_medium_slope']}, "
        f"medium_to_high_slope={row['value_per_work_event_medium_to_high_slope']}, "
        f"curvature={row['value_per_work_event_pressure_curvature']}",
