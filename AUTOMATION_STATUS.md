...
`ohdyn.analyze_a5_residual_accounting`. A 2026-06-29 02:44 PDT fixed smoke at seeds `5,6`
...
- Temporary smoke command passed:
  ...
  --out /tmp/omegasim_a5_current_FLqTb6/compare`.
- Temporary read-only residual accounting passed as a command and failed closed
  ...
  --compare-dir /tmp/omegasim_a5_current_FLqTb6/compare
  --out /tmp/omegasim_a5_current_FLqTb6/residual`.
