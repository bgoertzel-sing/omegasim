...
`ohdyn.analyze_a5_residual_accounting`. A 2026-06-29 05:47 PDT fixed smoke at seeds `5,6`
...
- Temporary smoke command passed:
  ...
  --out /tmp/omegasim_a5_current_dXj4iB/compare`.
- Temporary read-only residual accounting passed as a command and failed closed
  ...
  --compare-dir /tmp/omegasim_a5_current_dXj4iB/compare
  --out /tmp/omegasim_a5_current_dXj4iB/residual`.
